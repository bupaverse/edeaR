...
cases which have a throughput time in this interval. The time units in
...
- `filter_throughput_time(log)`: Filters cases for a
  [`log`](https://bupaverse.github.io/bupaR/reference/log.html).

- `filter_throughput_time(grouped_log)`: Filters cases for a
  [`grouped_log`](https://bupaverse.github.io/bupaR/reference/grouped_log.html).

## Functions

- `ifilter_throughput_time()`: Filter interactively
...
[`throughput_time()`](https://bupaverse.github.io/edeaR/reference/throughput_time.md),[`difftime()`](https://rdrr.io/r/base/difftime.html)
