...
#' @export
#'
redo_selfloops_referral_matrix <- function(log) {
...
redo_selfloops_referral_matrix.eventlog <- function(log) {
	first_resource <- NULL
	last_resource <- NULL
...
redo_selfloops_referral_matrix.activitylog <- function(log) {
