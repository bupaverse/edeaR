...
#'#'
#' @param level_of_analysis At which level the analysis of start activities should be performed: log or activity.
#'
...
start_activities <- function(eventlog,
	...
	if(!(level_of_analysis %in% c("log", "activity")))
		stop("Level of analysis should be one of the following: log, activity.")
